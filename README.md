...
3. Copy the content of `YourProjectFolder\` inside your game project mockup
4. Rename and update the Example Plugin
5. See provided BAT file on how to package the mod manually from CLI
6. Alternatively to #5, install Alpakit plugin from this repo and rebuild game project (do NOT install as Engine plugin) and use toolbar menu to package straight into game directory
